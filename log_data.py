...
run_timeout = True # Determines whether to end program after a certain time period
    ...
    while not exit_event.is_set():
        ...
        if should_process:
            ...
            with data_lock:
                ...
                # Keep only last 180 seconds of data in the plot (CSV keeps all)
...
if __name__ == "__main__":
    try:
        ...
        supply = E3644A("/dev/tty.usbmodemSN234567892")
